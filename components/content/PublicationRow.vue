...
<template>
    <div class="publication-row flex flex-col md:flex-row items-start mt-8 pb-8" :class="{'border-b-2': !hideBottomBorder}">

        <div class="prose dark:prose-invert max-w-none font-normal">
            <div>
                <span class="mr-2 bg-gray-200 text-black py-[0.2em] text-sm px-2"> {{ venue.acronym }}'{{ venue.year % 1000 }}</span>
